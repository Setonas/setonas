    ...
    if (NCH(n) == 1) {
        ...
        switch (TYPE(n)) {
            ...
            case NOTEQUAL:
                return NotEq;
            case NAME:
                if (strcmp(STR(n), "in") == 0 || strcmp(STR(n), "iš") == 0)
                    return In;
                if (strcmp(STR(n), "is") == 0 || strcmp(STR(n), "yra") == 0)
                    return Is;
            default:
        ...
        switch (TYPE(CHILD(n, 0))) {
            case NAME:
                if (strcmp(STR(CHILD(n, 1)), "in") == 0 || strcmp(STR(CHILD(n, 1)), "iš") == 0)
                    return NotIn;
                if (strcmp(STR(CHILD(n, 0)), "is") == 0 || strcmp(STR(CHILD(n, 0)), "yra") == 0)
                    return IsNot;
            default:
        ...
        case and_test:
            ...
            if (!strcmp(STR(CHILD(n, 1)), "and") || !strcmp(STR(CHILD(n, 1)), "ir"))
                return BoolOp(And, seq, LINENO(n), n->n_col_offset,
                              c->c_arena);
            assert(!strcmp(STR(CHILD(n, 1)), "or") || !strcmp(STR(CHILD(n, 1)), "arba"));
...
ast_for_try_stmt(struct compiling *c, const node *n)
{
    ...
    if (TYPE(CHILD(n, nch - 3)) == NAME) {
        if (strcmp(STR(CHILD(n, nch - 3)), "finally") == 0 ||
            strcmp(STR(CHILD(n, nch - 3)), "pagaliau") == 0) {
